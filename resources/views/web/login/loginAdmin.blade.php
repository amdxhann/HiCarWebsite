...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="jumbopict"><img src="{{ asset('web/images/login-admin2.gif') }}"  style="margin-left: 100px; margin-top: 60px;"></div>
      <div class="login">
        <div class="signin" style="margin-bottom: 50px;">
          <a href="/signUpAdmin" class="back" aria-label="Profile">
        ...
        <div class="forms">
          <form action="/" id="form">
            ...
            <div class="termsOfUse">
              ...
              <p style="margin-bottom: 20px;">Need an account?  
                <a href="/signUpAdmin">Sign up now!</a>
              </p>
