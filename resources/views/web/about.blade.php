            ...
            <div class="body">    
                <div class="grid">
                    <div class="grid-item">
                        <a href="#">
                        <div class="card"> 
                            <img class="card-img" src="{{ asset('web/images/people.gif') }}" style="width: 350px; height: 350px; border-radius: 50%; margin-left: 85px;"/>
                            <div class="card-content">
                            <h1 class="card-header" style="font-size: 30px; margin-top: 20px;">Asraf Ayyasi</h1>
                            </div>
                        </div>
                    </a>
                    </div>
                    ...
                    <div class="grid-item">
                        ...
                        <div class="card">
                            <img class="card-img" src="{{ asset('web/images/people.gif') }}" style="width: 350px; height: 350px; border-radius: 50%; margin-left: 85px;"/>
                                <div class="card-content">
                                <h1 class="card-header" style="font-size: 30px; margin-top: 20px;">Ahmad Rayhan</h1>
                                </div>
                        </div>
                    </a>
                    </div>
