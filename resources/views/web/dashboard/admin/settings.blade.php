        ...
        <div class="main">
            ...
            <div class="recentCustomers">
                <div class="cardHeader" style="text-align: center">
                    ...
                    <div class="bodycard">    
                        <div class="grid" style="position: absolute; margin-top: 100px; margin-left: 550px; width: 500px;">
                            <div class="grid-item" >
                                <a href="/login/signUpCustomer.html">
                                <div class="card">
                                    <div class="card-content">
                                    <h1 class="card-header" style="font-size: 30px; margin-top: 10px;">Switch Account</h1>
                                    </div>
                                </div>
                            </a>
                            </div>
                            ...
                            <div class="grid-item">
                                ...
                                <div class="card">
                                        <div class="card-content">
                                        <h1 class="card-header" style="font-size: 30px; margin-top: 10px;">Log Out</h1>
                                        </div>
                                </div>
                            </a>
                            </div>
