<html>
    ...
    <div class="container">
        ...
        <h2 class="h2 section-title" style="margin-left: 480px;">Explore Cars</h2>

        </div>

        <ul class="featured-car-list" style="margin-top: 10px;">
        ...
        <li>
            ...
            <div class="card-content">
                ...
                <li class="card-list-item">
                    ...
                    <span class="card-item-text">7.2km / 1-liter</span>
                </li>
